...
export default function EducationSciencePage() {
  return (
    <div className="min-h-screen bg-white p-6 space-y-6">
          ...
          <div className="bg-white  rounded-2xl flex-1 p-4 text-sm text-gray-700 ">
            <div className="flex gap-3 mb-2">
              {[1, 2].map((_, i) => (
                ...
                >
                  <div className="absolute top-1 right-1 w-5 h-5 rounded-full bg-white flex items-center justify-center border border-gray-200 text-gray-500 text-xs font-medium">
                    +
                  </div>
      ...
      <div className="flex min-h-screen bg-[#F9F8FC] p-6 rounded-2xl">
        ...
        <div className="flex-1 ml-6">
          <div className="bg-[#F1EEF9] p-4 rounded-2xl flex justify-between items-start">
            ...
            <button className="flex items-center gap-1 text-sm font-medium text-purple-500 cursor-pointer">
              <FiDownloadCloud className="w-4 h-4" />
              Download
            </button>
          </div>

          <table className="w-full mt-6 text-sm text-left bg-[#ffffff] rounded-xl px-4">
            ...
            <tbody>
              {[
                ...
                <tr key={id} className="border-b last:border-none">
                  ...
                  <td className="py-2 px-2 font-medium text-green-600 flex items-center gap-2">
