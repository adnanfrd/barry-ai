...
const favorites = [
  ...
  { name: "New list", href: "/dashboard", icon: FaCirclePlus, count: 0 },
];
...
export default function Sidebar() {
  ...
  return (
    <aside
      ...
      rounded-xl shrink-0 bg-[#faf9fa] dark:bg-[#1e1c21]  
      border-r border-gray-200 dark:border-gray-700 
      hidden md:flex flex-col shadow-sm`}
    >
      {/* Scrollable Content */}
      <div className="overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] max-h-full flex-1 p-4 flex flex-col justify-between">
        <div>
          {/* Header */}
