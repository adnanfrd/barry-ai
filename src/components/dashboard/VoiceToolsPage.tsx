...
export default function VoiceToolsPage() {
  return (
    <div className="min-h-screen bg-[#ffff] dark:bg-[#232127] p-4 text-sm text-black dark:text-white">
      <div className="flex justify-end">
        <div className="max-w-[90%] md:max-w-[75%] flex gap-20 mb-4 rounded-2xl border border-[#E2DFFC] dark:border-gray-700 overflow-hidden">
          <div className="flex-1 bg-white dark:bg-[#2b2b2b] px-4 py-3">
            <p className="text-sm text-gray-800 dark:text-gray-200 mb-2">
              Layer main distribute undo edit resizing export vertical. Export vertical move star plugin group scrolling figjam invite invite.
            </p>
          </div>
          <div className="w-14 bg-[#F4F1FF] dark:bg-[#3b3a4f] flex flex-col items-center py-2 px-1">
            <Image
              src="/image.png"
              alt="avatar"
              width={32}
            ...
            />
            <span className="text-[10px] text-gray-500 dark:text-gray-400 mt-1">12:22</span>
          </div>
        </div>
      </div>

      <div className="mt-3 mb-6 w-[80%] flex items-center justify-between bg-gray-100 dark:bg-gray-800 rounded-2xl px-4 py-2">
        ...
        <div className="ml-auto text-xs text-gray-600 dark:text-gray-400">00</div>
      </div>
      ...
      <div className="flex h-[60vh] bg-[#F9F8FC] dark:bg-[#27272a] gap-4 p-6 rounded-2xl">
        <div className="w-14 flex flex-col items-center bg-[#edebf1] dark:bg-[#3d3b45] rounded-2xl py-4 gap-6">
          ...
          <div className="text-[10px] text-gray-400 dark:text-gray-300 font-medium">12:22</div>
