...
export default function ChatsPage() {
  return (
    <div className="bg-white h-full  dark:bg-[#1a1a1a] rounded-2xl p-6 relative shadow-xl">
      ...
      <div className="relative z-10 mt-8 text-center">
        ...
        <h1 className="text-3xl font-bold mt-8 text-gray-800 dark:text-white">
          Fusion AI: Your Digital Co-Pilot
        </h1>
        <p className="text-gray-500 dark:text-gray-400 mt-4 max-w-xl mx-auto text-md">
      ...
      <div className="grid grid-cols-3 gap-4 mt-10 relative z-10">
        {[
          ...
          <Link key={tool.label} href={tool.href}>
            <div className="bg-[#faf9fa] dark:bg-[#2a2a2f] cursor-pointer hover:bg-[#f1eff3] dark:hover:bg-[#3a3a3f] py-8.5 px-4 rounded-xl flex flex-col items-center justify-center text-sm font-medium text-gray-700 dark:text-gray-300 shadow hover:shadow-md transition-all">
