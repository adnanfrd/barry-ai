...
export default function ChatsPage() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-[1fr_280px] gap-2 h-screen">
      <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl p-6 relative shadow-xl overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] flex flex-col">
        ...
        <div className="grid grid-cols-3 gap-4 mt-10 relative z-10">
          {[
            ...
            },
            {
              ...
              icon: (
                <BsFillFileEarmarkTextFill className="text-amber-600" />
              ),
        ...
        {/* Sticky Prompt Input */}
        <div className="sticky bottom-0 bg-white dark:bg-[#1a1a1a] pt-4 z-20 mt-6">
          <PromptInput />
        </div>
      </div>
