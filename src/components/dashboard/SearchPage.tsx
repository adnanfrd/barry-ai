  ...
  const todayItems = [
    {
      ...
      time: "now",
      content:
        "Reassisting device boolean component layout auto plugin select object font...",
    },
    {
      title: "Pencil comment image scale duplicate bullet duplicate outline",
      time: "28m ago",
      content:
        "Style pen device image shadow link resizing figjam. Duplicate union v...",
    },
    {
      title: "Pixel arrange team invite thumbnail ipsum opacity export arrow",
      time: "5:37 a.m.",
      content:
        "Scrolling slice distribute style content layout. Create thumbnail union el...",
    },
    {
      title: "Comment boolean clip link ipsum layout stroke.",
      time: "Oct 04, 2021",
      content:
        "Horizontal boolean clip group boolean undo comment. Fill arrange d...",
    },
  ];
  ...
  const last30Items = [
    {
      ...
      time: "9:15 a.m.",
      content:
        "Layer effect link undo effect. Pencil prototype slice auto undo scale flat...",
    },
    {
      title: "Align auto hand resizing stroke resizing blur connection",
      time: "Thu 4:56 p.m.",
      content:
        "Link figjam layout content team opacity. Pencil vector share opaci...",
    },
    {
      title: "Vertical team inspect mask link text",
      time: "Apr 01, 2022",
      content:
        "Blur rotate text auto figma. Thumbnail clip arrange text selection clip...",
    },
    {
      title: "Selection select layout blur draft select draft",
      time: "Yd 2:35 a.m.",
      content:
        "Opacity layer slice duplicate text community library distribute arrow...",
    },
  ];

  return (
    <div className="min-h-screen bg-white p-6 space-y-6 rounded-xl ">
      <h1 className="text-2xl p-2 px-4 py-2 font-bold mb-6">Search</h1>
