...
export default function WelcomePage() {
  return (
    <div className="min-h-[90vh] rounded-b-xl h-[90vh] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] bg-[#ffff] dark:bg-[#232127] p-4 text-sm">
      ...
      <div className="sticky bottom-0 bg-white dark:bg-[#1c1c1f] border-gray-200 dark:border-gray-700 px-4 py-3">
        <PromptInput />
      </div>
    </div>
  );
