...
export default function WelcomePage() {
  return (
    <div className="min-h-screen bg-[#ffff] dark:bg-[#232127] p-4 text-sm">
      <div className="flex justify-end">
        <div className="max-w-[90%] md:max-w-[75%] flex gap-20 mb-4 rounded-2xl border border-gray-300 dark:border-[#6a5e8f] overflow-hidden">
          ...
          <div className="w-14 bg-[#F4F1FF] dark:bg-[#27212F] flex flex-col items-center py-2 px-1">
            <Image
              src="/image.png"
              alt="avatar"
              width={50}
      ...
      <div className="mt-3 mb-6 w-[80%] flex items-center justify-between bg-gray-100 dark:bg-[#302d35] rounded-2xl px-4 py-2">
        ...
        <div className="ml-auto text-xs text-gray-600 dark:text-gray-300">00</div>
      </div>

      <div className="flex h-[60vh] bg-[#F9F8FC] dark:bg-[#18181B] gap-4 p-6 rounded-2xl">
        <div className="w-14 flex flex-col items-center bg-[#edebf1] dark:bg-[#2b2a33] rounded-2xl py-4 gap-6">
          <div className="bg-[#EBE9F7] dark:bg-[#3c384a] p-2 rounded-xl">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <div className="flex items-center bg-white dark:bg-[#2a2a2f] border border-gray-200 dark:border-gray-600 px-2 py-1 rounded-md text-sm text-gray-700 dark:text-gray-300 gap-1 cursor-pointer">
              <span>En (US)</span>
              <PiCaretDown className="w-4 h-4 text-gray-500 dark:text-gray-400" />
            </div>

            <div className="flex items-center bg-white dark:bg-[#2a2a2f] border border-gray-200 dark:border-gray-600 px-2 py-1 rounded-md text-sm text-gray-700 dark:text-gray-300 gap-1 cursor-pointer">
              <span>
                Voice <strong className="dark:text-white">Marry</strong>
              </span>
              <PiCaretDown className="w-4 h-4 text-gray-500 dark:text-gray-400" />
            </div>
          </div>
