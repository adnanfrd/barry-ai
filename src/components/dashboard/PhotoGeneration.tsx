...
export default function PhotoGenerationPage() {
  return (
    <div className="min-h-screen bg-[#ffff] dark:bg-[#232127] p-4 text-sm text-gray-900 dark:text-gray-200">
      <div className="flex justify-end">
        <div className="max-w-[90%] md:max-w-[75%] flex gap-20 mb-4 rounded-2xl border border-[#E2DFFC] dark:border-[#3f3f5f] overflow-hidden">
          <div className="flex-1 bg-white dark:bg-[#2a2a3d] px-4 py-3">
            <p className="text-sm text-gray-800 dark:text-gray-200 mb-2">Retouch this photo</p>
      ...
      <div className="mt-3 mb-6 w-[80%] flex items-center justify-between bg-gray-100 dark:bg-[#333344] rounded-2xl px-4 py-2">
      ...
      <div className="flex h-[60vh] bg-[#F9F8FC] dark:bg-[#2f2f45] gap-4 p-6 rounded-2xl">
